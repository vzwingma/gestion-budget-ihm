...
> Skill: instructions `/compact` optimisées, sessions Plans d'Action ou workflows SDLC multi-phases.
> But : éviter accumulation skill blobs (~4-8KB chacun) entre phases.
...
> 💡 Règle : `usage_input_tokens` >30K dans `/usage` → compacter immédiat.