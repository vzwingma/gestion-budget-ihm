 ...
 */
export function saveOperation(operation : OperationModel, budget : BudgetMensuelModel) {
 ...
 */
export function saveOperationIntercompte(operation : OperationModel, budget : BudgetMensuelModel, compteCible : CompteBancaireModel) {
