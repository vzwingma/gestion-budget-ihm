...
export function getDefaultAnalysesFilters(): AnalysesFiltersModel {
    return {
        selectedTypes: [TYPES_CATEGORIES_OPERATION_ENUM.ESSENTIEL, TYPES_CATEGORIES_OPERATION_ENUM.IMPREVUS, TYPES_CATEGORIES_OPERATION_ENUM.PLAISIR, TYPES_CATEGORIES_OPERATION_ENUM.EXTRAS],
        selectedOperationEtats: [OPERATION_ETATS_ENUM.PREVUE],
        selectedOperationTypes: [TYPES_OPERATION_ENUM.DEPENSE],
        selectedCategories: [],
